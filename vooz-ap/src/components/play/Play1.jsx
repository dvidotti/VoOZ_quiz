...
class Play1 extends Component {
  constructor(props) {
    ...
    this.url = '/audios/intermediate.mp3'
    ...
    return (
      <div>
        <div className="full-page-white">
          <NavBar />
          <h1 className="instruction">Escute, depois cante.<br/>Repita a melodia</h1>
          {button}
          <div className="next">
            <Link  to='/q1'><button  onClick={this.next}><img className='next-image' src={'/img/next.svg'} alt="next"/></button></Link>
          </div>
          <div className='legend-block-black'>
            <img className="legend-white" src={'/img/Legenda 1 Mobile.svg'} alt="progress"/>
          </div>
        </div>
        <Footer />
      </div>
